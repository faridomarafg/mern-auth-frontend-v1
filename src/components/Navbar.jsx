...
const Navbar = () => {
  ...
  return (
    <div className='w-screen h-[140px] z-10 bg-slate-400 text-white fixed drop-shadow-lg'>
      <div className='px-2 flex justify-between items-center w-full h-full'>
        <div className='flex items-center justify-between w-full'>
          <h1 className='text-3xl font-bold mr-4 sm:text-4xl font-playfair hover:scale-110 duration-1000 pl-4'>AFG - DEVS - BLOG</h1>
          ...
          <li className='hover:scale-110 font-semibold duration-1000 text-xl'>
            <Link className='hover:text-emerald-600 duration-1000 ' to="/dashboard"  >Dashboar</Link>
          </li>
          <li className='hover:scale-110 font-semibold duration-1000 text-xl'>
      ...
      'absolute bg-slate-400 opacity-70  w-[300px] h-screen px-8 right-0 items-center justify-center flex flex-col gap-6 duration-1000'
        ...
        (<>
          ...
          <li className='hover:scale-110 font-semibold duration-1000 text-xl'>
            <Link onClick={handleClose} className='hover:text-emerald-600 duration-1000 ' to="/dashboard"  >Dashboar</Link>
          </li>
          <li className='hover:scale-110 font-semibold duration-1000 text-xl'>
            <button onClick={onLogout}>
              Logout
